...
print(total_loans_amount)
# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
# YOUR CODE HERE!
average_loan_price = total_loans_amount / total_number_of_loans
...
# YOUR CODE HERE!
def present_calculate(future_value, remaining_months, annual_discount_rate):
    present_value = future_value / (1+ annual_discount_rate/ 12)**remaining_months
    return present_value 
# @TODO: Use the function to calculate the present value of the new loan given below.
#    Use an `annual_discount_rate` of 0.2 for this new loan calculation.
# YOUR CODE HERE!
present_value = present_calculate(1000, 16,0.2)
...
for loan_price in loans:
    ...
    if loan_price.get("loan_price") <= 500:
        inexpensive_loans.append(loan_price.get("loan_price"))
